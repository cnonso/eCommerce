<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="eCommerceTemplate.Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="site-wrap">
            ...
            <div class="site-blocks-cover" style="background-image: url('images/wallpaper.png');">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
                            <div class="site-block-cover-content text-center">
                                <h2 style="color:#24166d" class="sub-title">Effective Medicine, New Medicine Everyday</h2>
                                <h1 style="color:#24166d">De-Elbon Pharmaceutical Ltd.</h1>
                                <p>
                                    <a href="../Views/store.aspx" class="btn btn-primary px-5 py-3">Shop Now</a>
                                    <a href="../Views/warehousestore.aspx" class="btn btn-primary px-5 py-3">Wholesale Order</a>
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="banner-wrap bg-primary h-100">
                                <a href="#" class="h-100">
                                    <h5>Free
                                        ...
                                        Shipping</h5>
                                    <p>
                                       within Port Harcourt City
                 
                                        <strong>₦1000 delivery fee outside the city.</strong>
                                    </p>
                                </a>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <script>
                            ...
                            var itemName;
                            function AddToList(productid, productname, sellingprice, qtyonhand, itemcode, minqty, catgeory) {
                                ...
                                document.getElementById('<%=txtCategory.ClientID%>').value = catgeory;
                    ...
                    <div class="row mt-5">
                        <div class="col-12 text-center">
                            <a href="../Views/store.aspx" class="btn btn-primary px-4 py-3">View All Products</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="block-5 mb-5">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="phone"><a href="tel://08033108325">+234 803 310 8325</a><br /> <a href="tel://08033108325">+234 803 310 8325</a></li>
