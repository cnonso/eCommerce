    ...
    public class DailySalesEntry
    {
        ...
        public bool MakeEntry()
        {
            ...
            string addEntryQuery = @"INSERT INTO Products_Trans ([ProductID], [QtyonHand], [Description], [In Flow], [Out Flow], [Date], [Year])" +
                                    "VALUES('" + _productId + "','" + newQty + "','" + _description + "','','" + _outFlow + "','" + _date + "','" + _year + "')";
        ...
        public bool SalesSummary()
        {
            ...
            string salesPaymentQuery = @"INSERT INTO Sales_Payment ([Customer Name], [CustomerID], [ReceiptNo], [Amount], [Cash At Hand], [Bank], [Details], [Date],[UserType])" +
                                    "VALUES('" + _customerName + "','" + _customerId + "','" + _receiptNo + "','" + _summaryTotalAmount + "','" + _cashAtHand + "','" + _bank + "','" + _paymentMode + "','" + _date + "','" + _userType + "')";
        ...
        internal bool UpdatePayment(string receiptNo, string originatingReceiptNo, string moreDetails)
        {
            string paymentQuery = @"INSERT INTO Sales_Payment ([Customer Name], [CustomerID], [ReceiptNo], [Amount], [Cash At Hand], [Bank], [Details], [Date],[UserType],[OriginatingReceiptNo],[Category], [MoreDetails])" +
                                  "VALUES('" + _customerName + "','" + _customerId + "','" + receiptNo + "','" + _summaryTotalAmount + "','" + _cashAtHand + "','" + _bank + "','" + _paymentMode + "','" + _date + "','" + _userType + "','" + originatingReceiptNo + "','PAYMENT','" + moreDetails + "');";
          
            string updateTransactionQuery = "UPDATE Sales_Transactions SET [Paid Later] ='" + PaidLater +
                            "', [Amount Paid] =[Amount Paid] +'" + _cashAtHand +
                            "', [Balance] ='" + Balance +
                            "', [Date] ='" + Date +
                            //"' WHERE [ReceiptNo]='" + receiptNo + "';";
                            "' WHERE [ReceiptNo]='" + originatingReceiptNo + "';";

            string updateCustomerCreditQuery = "UPDATE Customers SET [Credit] ='" + Balance +
                            "' WHERE [ID]='" + CustomerID + "'";

            return db.ExecuteQuery(paymentQuery + updateTransactionQuery + updateCustomerCreditQuery);
            //return db.ExecuteQuery(paymentQuery + updateCustomerCreditQuery);
        }
    }
}