        ...
        private void LoadAllProducts()
        {
            ...
            if (products.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in products.Rows)
                {
                    ...
                    string addToCart = "<a title=\"Add " + productname + " to cart.\" style='cursor:pointer' onclick=\"AddToList('" + dr["ID"] + "','" + productname + "','" + dr["Selling_Price"] + "','" + dr["QtyonHand"] + "','" + dr["Product Code"] + "','" + dr["MinQty"] + "' )\"><i class=\"fa fa-plus\"></i> Add</a> ";
