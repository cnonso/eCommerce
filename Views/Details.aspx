<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="eCommerceTemplate.Views.Details" %>
        ...
        <div class="site-wrap">
                        ...
                        <div class="logo">
                            <div class="site-logo">
                                <a href="default.aspx" class="js-logo-clone"> 
                                    <img src="../mages/logo.jpg" height="50" />
                                </a>
                            </div>
                        </div>
                        <div class="main-nav d-none d-lg-block">
                            <nav class="site-navigation text-right text-md-center" role="navigation">
                                <ul class="site-menu js-clone-nav d-none d-lg-block">
                                    ...
                                    <li><a href="../Views/Store.aspx">Store</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 mb-0">
                            <a href="../default.aspx">Home</a> <span class="mx-2 mb-0">/</span> <a
                                href="Store.aspx">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black"><%Response.Write(productName); %></strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="site-section">
                    ...
                    <div class="row">
                        <div class="col-md-5 mr-auto">
                            <div class="border text-center">
                                <img src="<%Response.Write(productImage); %>" alt="Image" width="900" class="img-fluid p-5">
                            </div>
                        </div>
                        <div class="col-md-6">

                            <asp:Label ID="lblReport" runat="server" Text=""></asp:Label>
                            <h2 class="text-black"><%Response.Write(productName); %></h2>
                            <p>
              ...
              distinctio, aperiam, ratione dolore.
                            ...
                            <p><strong class="text-primary h4"><%Response.Write(productPrice); %></strong></p>
                            ...
                            <div class="mb-5">
                                <div class="input-group mb-3" style="max-width: 220px;">
                                    ...
                                    <asp:TextBox ID="txtQty" CssClass="form-control text-center" runat="server" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">1</asp:TextBox>
                            ...
                            <p>
                                <asp:Button CssClass="buy-now btn btn-sm height-auto px-4 py-3 btn-primary" ID="btnAddToCart" OnClick="btnAddToCart_Click" OnClientClick="SetTimer();" runat="server" Text="Add To Cart" />
                            </p>
                            <p style="display: none"><a href="cart.html" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Add To Cart</a></p>
