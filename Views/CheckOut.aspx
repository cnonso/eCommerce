<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CheckOut.aspx.cs" Inherits="eCommerceTemplate.Views.CheckOut" %>
                ...
                <div class="col-md-12">
                    <div class="bg-light rounded p-3">
                        <%if (Session["username"] == null)
                            { %>
                        <p class="mb-0">Returning customer? <a href="../Login.aspx" class="d-inline-block">Click here</a> to login</p>
                        <%} %>
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-3 p-lg-5 border">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <asp:TextBox ID="txtAddress" placeholder="Street address" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="c_create_account" class="text-black" data-toggle="collapse" href="#create_an_account"
                                role="button" aria-expanded="false" aria-controls="create_an_account" style="display: block">
                      ...
                      please login at the top of the page.
                                    ...
                                    <div class="form-group">
                                        <label for="c_account_password" class="text-black">Retype Password</label>
                                        <input type="password" class="form-control" id="c_account_password2" name="c_account_password"
                                            placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="c_account_password" class="text-black">License No.</label>
                                        <input type="text" class="form-control" id="c_license_no" name="c_account_password"
                                            placeholder="">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-black font-weight-bold"><strong>
                                                <asp:Label ID="lblTotalPrice" runat="server" Text=""></asp:Label></strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                          ...
                          payment reference. Your order won’t be shipped until the funds have cleared in our account.
                                ...
                                <div class="border mb-5">
                                    <h3 class="h6 mb-0"><a class="d-block" data-toggle="collapse" href="#collapsepaypal" role="button"
                                        aria-expanded="false" aria-controls="collapsepaypal">Credit/Debit Card</a></h3>
                                ...
                                <div class="form-group">
                                    <asp:Button ID="btnPlaceOrder" OnClick="btnPlaceOrder_Click" CssClass="btn btn-primary btn-lg btn-block" runat="server" Text="Place Order" />
                                    <button class="btn btn-primary btn-lg btn-block" style="display: none" onclick="window.location='thankyou.html'">Place Order</button>
